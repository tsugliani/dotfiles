...
# Timestamp format
case $HIST_STAMPS in
  "mm/dd/yyyy") alias history='_history_fn -f' ;;
  "dd.mm.yyyy") alias history='_history_fn -E' ;;
  "yyyy-mm-dd") alias history='_history_fn -i' ;;
  *) alias history='_history_fn' ;;
esac
